...
match option:
    case "Air pollution risk":
        ...
        functions.facilities(dataframe=apr2023_df, fields_name="Combined_2",
                             aliases="Air pollution risk:", map=m)
    case "Monitoring stations":
        #add monitoring stations to map
        functions.facilities(dataframe=ms_df, fields_name="Name",
                             aliases="Monitoring station:", map=m)
    case "SVI":
        # Add social vulnerability index to map
        functions.facilities(dataframe=svi_df,fields_name="SVI", aliases="Social vulnerability index: ", map=m)
